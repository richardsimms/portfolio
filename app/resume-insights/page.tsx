...
export const metadata: Metadata = {
  title: "Resume Insights | Richard Simms",
  description: "I help product deigners create more impactful work.",
  openGraph: {
    title: "Resume Insights | Richard Simms",
    description: "I help product deigners create more impactful work.",
    type: "website",
    url: "https://rsimms.com/resume-insights",
    images: [{ url: "https://rsimms.com/api/og?title=resume-insights", alt: "Resume Insights" }],
  },
};
      ...
      <div className="flex flex-col gap-16 md:gap-24">
        <div className="flex animate-in flex-col gap-8">
          ...
          <li
            ...
            style={{ "--index": 9 } as React.CSSProperties}
            >
            Click on the _compare the CV to Job_ button   
          </li>
          <li
            className="animate-in text-secondary"
            style={{ "--index": 9 } as React.CSSProperties}
