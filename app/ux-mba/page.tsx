...
export const metadata: Metadata = {
  title: "UX MBA | Richard Simms",
  description: "Transform business with visionary leadership: Beyond aesthetics to impactful design strategy",
  openGraph: {
    title: "UX MBA | Richard Simms",
    description: "Transform business with visionary leadership: Beyond aesthetics to impactful design strategy",
    type: "website",
    url: "https://rsimms.com/ux-mba",
    images: [{ url: "https://rsimms.com/api/og?title=ux-mba", alt: "UX MBA" }],
  },
};
