...
date: "2020-2020"
summary: "Helpping healthcare workers obtain scrubs"
longSummary: "Rona Scrubs is a registered not for profit charity established on 1 April 2020 in response to the COVID-19 pandemic reaching Australia's shores and feedback from healthcare workers that they were unable to obtain scrubs to help them prevent the spread of COVID-19. Operations were wound up on 31 July when we completed 100% of orders."
url: "https://www.facebook.com/watch/?v=754354945301805"
tags: ["Website",]
status: archived
---


Rona Scrubs is a registered not for profit charity established on 1 April 2020 in response to the COVID-19 pandemic reaching Australia's shores and feedback from healthcare workers that they were unable to obtain scrubs to help them prevent the spread of COVID-19. Operations were wound up on 31 July when we completed 100% of orders.
...
The impact of Rona Scrubs has been far greater than I ever imagined. Whilst the core aim to start was to help support healthcare workers minimise the potential spread of COVID it also quickly became and important refuge for many volunteers. Providing them with focus, purpose and friendship to get through the challenging times we were all facing. The psychological benefits to volunteers in participating far exceeded the original expectations of the founder and core team that made Rona Scrubs happen.
...
<Image
  src="/projects/ronascrubs/img-nurse.webp"
  alt="Nurses"
  width={2580}
  height={1691}
  caption="Nurses"
...
<Image
  src="/projects/ronascrubs/img-square.webp"
  alt="Cutting fabric"
  width={2580}
  height={1691}
  caption="Cutting fabric"
  contained  
/>

### The challenge
 There were many challenges on the journey, but the team that brought Rona Scrubs to life and helped thousands of volunteers and healthcare workers were formidable.
